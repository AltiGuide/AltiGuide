...
const weatherLabels = {
  cerah: { label: 'Cerah', icon: 'ΓÿÇ∩╕Å', color: 'text-green-700 bg-green-50 border-green-200' },
  berawan: { label: 'Berawan', icon: 'Γ¢à', color: 'text-gray-700 bg-gray-50 border-gray-200' },
  hujan: { label: 'Hujan', icon: '≡ƒîº∩╕Å', color: 'text-amber-700 bg-amber-50 border-amber-200' },
  extreme: { label: 'Cuaca Ekstrem', icon: 'Γ¢ê∩╕Å', color: 'text-red-700 bg-red-50 border-red-300' },
}
...
const docStatusIcon = (status) => {
  switch (status) {
    case 'verified': return { icon: 'Γ£ô', label: 'Terverifikasi', cls: 'text-green-700 bg-green-50' }
    case 'review': return { icon: 'ΓÅ│', label: 'Review', cls: 'text-amber-700 bg-amber-50' }
    case 'revisi': return { icon: 'ΓÜá', label: 'Revisi', cls: 'text-red-700 bg-red-50' }
...
<template>
  <div class="min-h-screen bg-[#F4F1E6] flex flex-col font-sans">
    <Head title="Admin Dashboard ΓÇö AltiGuide" />
    <!-- ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ Navbar ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ -->
    ...
    <!-- ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ Main Layout ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ -->
    <div class="flex flex-1 overflow-hidden">
      ...
      <main class="flex-1 overflow-y-auto px-6 py-6">
        ...
        <!-- ΓòÉΓòÉΓòÉ Weather Toggle (Dev Control) ΓòÉΓòÉΓòÉ -->
        <div class="mb-4 flex items-center gap-2">
          ...
          <select v-model="weatherStatus" class="text-xs border border-[#D6CCAF] rounded-lg px-2 py-1 bg-white text-[#374426] focus:outline-none focus:ring-1 focus:ring-[#64823E] cursor-pointer">
            <option value="cerah">ΓÿÇ∩╕Å Cerah</option>
            <option value="berawan">Γ¢à Berawan</option>
            <option value="hujan">≡ƒîº∩╕Å Hujan</option>
            <option value="extreme">Γ¢ê∩╕Å Cuaca Ekstrem</option>
          </select>
        ...
        <!-- ΓòÉΓòÉΓòÉ Stats Cards Row ΓòÉΓòÉΓòÉ -->
        ...
        <!-- ΓòÉΓòÉΓòÉ Administration Table ΓòÉΓòÉΓòÉ -->
        ...
        <!-- ΓòÉΓòÉΓòÉ Log Panels (Check-in / Check-out) ΓòÉΓòÉΓòÉ -->
              ...
              >
                ...
                <div class="flex items-start justify-between mb-2">
                  <div>
                    ...
                    <p class="text-[11px] text-[#8B9A7B]">≡ƒæñ Ketua: {{ group.leader }}</p>
                  </div>
              ...
              >
                ...
                <div class="flex items-center gap-2 mt-2 mb-2">
                  ...
                  <span :class="group.wasteStatus === 'ok' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-amber-50 text-amber-700 border-amber-200'" class="flex items-center gap-1 text-[9px] font-semibold px-2 py-0.5 rounded-full border">
                    {{ group.wasteStatus === 'ok' ? 'Γ£ô' : 'ΓÜá' }} Sampah {{ group.wasteStatus === 'ok' ? 'OK' : 'Selisih' }}
                  </span>
                </div>
    ...
    <!-- ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ Footer ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ -->
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto modal-enter z-10">
          ...
          <div class="sticky top-0 bg-[#374426] text-white px-6 py-4 rounded-t-3xl flex items-center justify-between z-10">
            <div>
              ...
              <p class="text-xs text-white/60 mt-0.5">{{ selectedOrder.id }} ΓÇó {{ selectedOrder.groupName }}</p>
            </div>
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto modal-enter z-10">
          ...
          <div class="sticky top-0 bg-[#A2825B] text-white px-6 py-4 rounded-t-3xl flex items-center justify-between z-10">
            <div>
              ...
              <p class="text-xs text-white/60 mt-0.5">{{ selectedCheckinGroup.name }} ΓÇó Ketua: {{ selectedCheckinGroup.leader }}</p>
            </div>
          ...
          <div class="p-6 space-y-6">
            ...
            <div v-if="isWeatherExtreme" class="flex items-center gap-3 p-4 bg-red-50 border border-red-300 rounded-2xl">
              <span class="text-2xl">Γ¢ê∩╕Å</span>
              <div>
                <p class="font-bold text-sm text-red-800">Cuaca Ekstrem ΓÇö Pemberangkatan Ditangguhkan</p>
            ...
            <div>
              <div class="flex items-center gap-2 mb-4">
                <div class="w-6 h-6 rounded-full bg-[#A2825B] text-white flex items-center justify-center text-xs font-bold">Γ£ô</div>
            ...
            <div>
              <div class="flex items-center gap-2 mb-4">
                <div class="w-6 h-6 rounded-full bg-[#A2825B] text-white flex items-center justify-center text-xs font-bold">ΓÖ╗</div>
            ...
            >
              ...
              <span v-if="isWeatherExtreme">Check-in Ditangguhkan ΓÇö Cuaca Ekstrem</span>
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto modal-enter z-10">
          ...
          <div class="sticky top-0 bg-[#6B8E4E] text-white px-6 py-4 rounded-t-3xl flex items-center justify-between z-10">
            <div>
              ...
              <p class="text-xs text-white/60 mt-0.5">{{ selectedCheckoutGroup.name }} ΓÇó Ketua: {{ selectedCheckoutGroup.leader }}</p>
            </div>
          ...
          <div class="p-6 space-y-6">
            ...
            <div>
              <div class="flex items-center gap-2 mb-4">
                <div class="w-6 h-6 rounded-full bg-[#6B8E4E] text-white flex items-center justify-center text-xs font-bold">ΓÖ╗</div>
                ...
                <table class="w-full text-xs">
                  ...
                  <tbody>
                    <tr v-for="item in wasteItems" :key="item.key" class="border-b border-[#F4F1E6] last:border-0">
                      ...
                      <td class="px-4 py-3 text-center">
                        <span v-if="item.turun >= item.naik" class="inline-flex items-center gap-1 text-green-700 bg-green-50 text-[10px] font-semibold px-2 py-0.5 rounded-full">Γ£ô OK</span>
                        <span v-else class="inline-flex items-center gap-1 text-red-700 bg-red-50 text-[10px] font-semibold px-2 py-0.5 rounded-full">ΓÜá {{ item.turun - item.naik }}</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="mt-3">
                <span v-if="allWasteOk" class="inline-flex items-center gap-1.5 bg-green-100 text-green-800 text-xs font-bold px-4 py-2 rounded-full border border-green-200">
                  Γ£ô SAMPAH OK ΓÇö Semua item cocok
                </span>
                <span v-else class="inline-flex items-center gap-1.5 bg-red-100 text-red-800 text-xs font-bold px-4 py-2 rounded-full border border-red-200">
                  ΓÜá SELISIH DITEMUKAN ΓÇö Periksa item yang kurang
                </span>
              </div>
            </div>
            ...
            <div>
              <div class="flex items-center gap-2 mb-4">
                <div class="w-6 h-6 rounded-full bg-[#6B8E4E] text-white flex items-center justify-center text-xs font-bold">≡ƒÅÑ</div>
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <select v-model="healthCondition" :class="healthConditionColor" class="w-full h-11 px-4 rounded-xl border text-sm font-semibold text-[#374426] focus:outline-none focus:ring-2 focus:ring-[#6B8E4E]/30 cursor-pointer transition-colors">
                    <option value="sehat">≡ƒƒó Sehat / Selamat</option>
                    <option value="luka_ringan">≡ƒƒí Luka Ringan</option>
                    <option value="luka_berat">≡ƒö┤ Luka Berat</option>
                    <option value="meninggal">ΓÜ½ Meninggal</option>
                  </select>
                </div>
...
<style scoped>
/* ΓòÉΓòÉΓòÉ Modal Transitions ΓòÉΓòÉΓòÉ */
...
/* ΓòÉΓòÉΓòÉ Slide Down Transition ΓòÉΓòÉΓòÉ */
...
/* ΓòÉΓòÉΓòÉ Overdue Pulse Animation ΓòÉΓòÉΓòÉ */
.overdue-pulse {
...
/* ΓòÉΓòÉΓòÉ Weather Extreme Banner Animation ΓòÉΓòÉΓòÉ */
...
/* ΓòÉΓòÉΓòÉ Scrollbar Styling ΓòÉΓòÉΓòÉ */
