          ...
          <div class="flex gap-16">
            <div class="flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-3 text-[#5A684C] text-xs">
                <a href="#" class="hover:text-[#374426] transition-colors">Daftar Gunung</a>
                <a href="#" class="hover:text-[#374426] transition-colors">Jalur Pendakian</a>
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-3 text-[#5A684C] text-xs">
                <a href="#" class="hover:text-[#374426] transition-colors">Tata Tertib</a>
                <a href="#" class="hover:text-[#374426] transition-colors">Booking Simaksi</a>
                <a href="#" class="hover:text-[#374426] transition-colors">Tips Keamanan</a>
              </div>
            </div>
            <div class="flex flex-col gap-4">
              <h5 class="text-[#374426] font-semibold text-sm">Komunitas</h5>
              <div class="flex flex-col gap-3 text-[#5A684C] text-xs">
                <a href="#" class="hover:text-[#374426] transition-colors">Event Mendaki</a>
                <a href="#" class="hover:text-[#374426] transition-colors">Forum Diskusi</a>
                <a href="#" class="hover:text-[#374426] transition-colors">Tentang Kami</a>
              </div>
            </div>
          </div>
        </div>
