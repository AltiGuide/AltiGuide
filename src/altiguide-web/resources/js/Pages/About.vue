...
<template>
  <div class="min-h-screen bg-[#F8F3E4] font-sans flex flex-col">
    <Head title="Tentang Kami - AltiGuide" />
    ...
    <nav class="w-full flex justify-between items-center px-4 md:px-8 xl:px-12 py-4 border-b border-[#D7DDC2]/50 shadow-sm bg-[#374426]/20">
      ...
      <div class="flex items-center gap-4 md:gap-6 xl:gap-9 text-sm md:text-base font-semibold text-[#374426]">
        ...
        <template v-else>
          <a href="/login" class="border border-[#374426] px-4 md:px-5 py-2 rounded-lg hover:bg-[#374426] hover:text-white transition duration-200">Login</a>
        </template>
      </div>
    </nav>
    ...
    <main class="w-full flex-1 flex flex-col items-center mt-12 pb-24 px-4">
      <div class="w-full max-w-[1100px] flex flex-col gap-16">
        
        <!-- Header -->
        <div class="text-center">
          <h1 class="text-[#64823E] font-bold text-[56px] drop-shadow-md mb-6" style="font-family: 'Montserrat', sans-serif;">Tentang Kami</h1>
          <p class="text-[#5A684C] text-[18px] leading-relaxed max-w-3xl mx-auto" style="font-family: 'Montserrat', sans-serif;">
            AltiGuide adalah platform pemesanan simaksi dan pusat informasi pendakian terintegrasi. Kami berdedikasi untuk mempermudah petualangan Anda di alam bebas dengan menyediakan layanan yang aman, mudah, dan transparan.
          </p>
        </div>

        <!-- Visi & Misi -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div class="bg-[#D6CCAF] p-10 rounded-[30px] shadow-lg flex flex-col gap-4">
            <h3 class="text-[#374426] font-bold text-[32px]" style="font-family: 'Montserrat', sans-serif;">Visi</h3>
            <p class="text-[#5A684C] text-[16px] leading-relaxed" style="font-family: 'Montserrat', sans-serif;">
              Menjadi pionir dalam digitalisasi pengelolaan pendakian gunung di Indonesia, menciptakan ekosistem pariwisata alam yang berkelanjutan, aman, dan dapat diakses oleh semua kalangan.
            </p>
          </div>
          <div class="bg-[#D6CCAF] p-10 rounded-[30px] shadow-lg flex flex-col gap-4">
            <h3 class="text-[#374426] font-bold text-[32px]" style="font-family: 'Montserrat', sans-serif;">Misi</h3>
            <ul class="list-disc list-inside text-[#5A684C] text-[16px] leading-relaxed space-y-2" style="font-family: 'Montserrat', sans-serif;">
              <li>Memudahkan proses administrasi simaksi secara online.</li>
              <li>Menyediakan informasi rute dan cuaca secara real-time.</li>
              <li>Mengedukasi pendaki tentang tata tertib dan pelestarian alam.</li>
              <li>Membangun komunitas pecinta alam yang solid dan suportif.</li>
            </ul>
          </div>
        </div>
        ...
        <div class="flex flex-col items-center">
          <h2 class="text-[#374426] font-bold text-[40px] mb-10" style="font-family: 'Montserrat', sans-serif;">Tim AltiGuide</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 w-full">
            <!-- Team Member 1 -->
            <div class="bg-white rounded-[24px] overflow-hidden shadow-md hover:shadow-xl transition-shadow flex flex-col items-center p-6 text-center">
              <div class="w-32 h-32 rounded-full bg-[#E0DBBE] mb-4 overflow-hidden border-4 border-[#D7DDC2]">
                <img src="/images/mountain_bg.png" alt="Team 1" class="w-full h-full object-cover" />
              </div>
              <h4 class="text-[#374426] font-bold text-[22px]" style="font-family: 'Montserrat', sans-serif;">Nama Anggota 1</h4>
              <p class="text-[#64823E] font-medium text-[14px] mb-2">CEO & Founder</p>
              <p class="text-[#5A684C] text-[14px]">Membawa inovasi untuk pengalaman mendaki yang lebih baik.</p>
            </div>
            
            <!-- Team Member 2 -->
            <div class="bg-white rounded-[24px] overflow-hidden shadow-md hover:shadow-xl transition-shadow flex flex-col items-center p-6 text-center">
              <div class="w-32 h-32 rounded-full bg-[#E0DBBE] mb-4 overflow-hidden border-4 border-[#D7DDC2]">
                <img src="/images/mountain_bg.png" alt="Team 2" class="w-full h-full object-cover" />
              </div>
              <h4 class="text-[#374426] font-bold text-[22px]" style="font-family: 'Montserrat', sans-serif;">Nama Anggota 2</h4>
              <p class="text-[#64823E] font-medium text-[14px] mb-2">Lead Developer</p>
              <p class="text-[#5A684C] text-[14px]">Memastikan seluruh sistem simaksi berjalan lancar dan aman.</p>
            </div>

            <!-- Team Member 3 -->
            <div class="bg-white rounded-[24px] overflow-hidden shadow-md hover:shadow-xl transition-shadow flex flex-col items-center p-6 text-center">
              <div class="w-32 h-32 rounded-full bg-[#E0DBBE] mb-4 overflow-hidden border-4 border-[#D7DDC2]">
                <img src="/images/mountain_bg.png" alt="Team 3" class="w-full h-full object-cover" />
              </div>
              <h4 class="text-[#374426] font-bold text-[22px]" style="font-family: 'Montserrat', sans-serif;">Nama Anggota 3</h4>
              <p class="text-[#64823E] font-medium text-[14px] mb-2">Community Manager</p>
              <p class="text-[#5A684C] text-[14px]">Menghubungkan jutaan pendaki di seluruh Nusantara.</p>
            </div>
          </div>
        </div>
